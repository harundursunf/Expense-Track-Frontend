  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md">
      ...
      <input
        ...
        className="w-full p-4 bg-gray-50 border-b-2 border-gray-300 rounded-t-md focus:outline-none focus:border-green-600 transition duration-200 mb-6 placeholder-gray-500"
        required
      />
      ...
      <input
        ...
        value={form.password}
        onChange={handleChange}
        className="w-full p-4 bg-gray-50 border-b-2 border-gray-300 rounded-t-md focus:outline-none focus:border-green-600 transition duration-200 mb-8 placeholder-gray-500"
        required
      />
