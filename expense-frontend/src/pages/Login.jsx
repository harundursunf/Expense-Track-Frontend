  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md">
      ...
      <input
        ...
        className="w-full p-4 bg-gray-50 border-b-2 border-gray-300 rounded-t-md focus:outline-none focus:border-blue-600 transition duration-200 mb-6 placeholder-gray-500"
        required
      />
      ...
      <input
        ...
        value={form.password}
        onChange={handleChange}
        className="w-full p-4 bg-gray-50 border-b-2 border-gray-300 rounded-t-md focus:outline-none focus:border-blue-600 transition duration-200 mb-8 placeholder-gray-500"
        required
      />
      ...
      <p className="mt-10 text-sm text-center text-gray-700">
        Hesabın yok mu?{" "}
        <Link to="/register" className="text-blue-800 hover:underline hover:text-blue-900 transition duration-200">
          Kayıt Ol
        </Link>
      </p>
    </form>
